...
const BORDERS = [
  {
    id: "b1", name: "Esment", description: "TBD", link: "", color: "#8a2f2f", closed: true, weight: 2, dashArray: "6,4", fillOpacity: 0.07, points: [
  ...
  { id: "b3", name: "Rue", description: "", link: "", color: "#5a3a2a", closed: true, weight: 2, dashArray: null, fillOpacity: 0.08, points: [
