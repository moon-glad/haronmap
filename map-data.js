...
const BORDERS = [
  {
    ...
    points: [
      ...
      [ { x: 67.2, y: 23.2 }, { x: 67.3, y: 24.3 }, { x: 67, y: 25.1 } ]
    ]
  }
  { id: "b1", name: "Unnamed", description: "", link: "", color: "#5a3a2a", closed: true, weight: 2, dashArray: null, fillOpacity: 0.08, points: [
      [ { x: 50.6, y: 15.7 }, { x: 50.7, y: 17 }, { x: 52.1, y: 16.9 }, { x: 51.8, y: 15.2 }, { x: 50.6, y: 15.7 } ],
      [ { x: 52.7, y: 13.6 }, { x: 52.8, y: 15 }, { x: 55, y: 14.6 }, { x: 54.7, y: 12.1 }, { x: 52.9, y: 10.8 }, { x: 51.1, y: 12.3 }, { x: 53.1, y: 12.9 }, { x: 51.2, y: 13.4 }, { x: 52.7, y: 13.6 } ]
  ] }
];
